...
public class starter {
    ...
    public static void main(String[] args) {
        ...
        int rizzPower = (int)(Math.random()*30+10);
        int sigmaSpeed = (int)(Math.random()*30+10);
        int brainrotEnergy = (int)(Math.random()*25+5);
        System.out.println("Stats: ");
        System.out.println("rizzPower: " + rizzPower);
        System.out.println("sigmaSpeed: " + sigmaSpeed);
        System.out.println("brainrotEnergy: " + brainrotEnergy);
        ...
        System.out.println();
        int rivalHealth = (int)(Math.random()*(50 + 80));
        int rivalPower = (int) (Math.random()*(35+15));
        int rivalDefense = (int) (Math.random()*(20 + 5));
        System.out.println("rival's stats:");
        System.out.println("rivalHealth: " + rivalHealth);
        System.out.println("rivalPower: " + rivalPower);
        System.out.println("rivalDefense: " + rivalDefense);
        System.out.println();
        ...
        double fateRoll = Math.random()*(2.0+0.5);
        ...
        System.out.println();
        int rawDamage = (int)heroPower * (int)fateRoll;
        ...
        int rivalHealthRemaining = Math.min(0,rivalHealth-rivalHealth);
        ...
        //     to (int).
        double rivalFuryRoll = Math.random()*(1.0 + 1.5);
        int rivalDamage = rivalPower * (int)rivalFuryRoll;
        ...
        int heroHealthRemaining = Math.min(0, 100 - rivalDamage);
        ...
        int basePoints = (int)(Math.random()*(300-50) + 300);
        ...
        int bonusPoints = Math.max(damageDealt,100);
        int totalRizz = basePoints + bonusPoints;
